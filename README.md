...
**Exports** : bouton **Exporter Excel** (classeur `.xlsx` à deux feuilles — *Ventes* et *Tableau de bord*), ainsi que CSV et JSON. **Recharger l'historique d'origine** (onglet Ventes) restaure les 69 ventes + la Balance embarquées.
